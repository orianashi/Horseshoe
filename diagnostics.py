...
print(f"src A metallicity from intersection w/ pettini 2004 N2 diagnostic line: {N2_metal_A}" )
print(f"src B metallicity from intersection w/ pettini 2004 N2 diagnostic line: {N2_metal_B}" )
...
# calcualte O3N2 
o3n2A, o3n2A_err = ratios(OIIIbetas['A']['OIIIbeta'],  NIIalphas['A']['NIIalpha'],OIIIbetas['A']['OIIIbeta_uncert'],NIIalphas['A']['NIIalpha_uncert'])
o3n2B, o3n2B_err = ratios(OIIIbetas['B']['OIIIbeta'],  NIIalphas['B']['NIIalpha'],OIIIbetas['B']['OIIIbeta_uncert'],NIIalphas['B']['NIIalpha_uncert'])
log_o3n2A, log_o3n2A_err = log_uncert(o3n2A, o3n2A_err)
log_o3n2B, log_o3n2B_err = log_uncert(o3n2B, o3n2B_err)
print(f"log([OIII]/Hbeta / [NII/Halpha]) for source A: {log_o3n2A} +- {log_o3n2A_err}")
print(f"log([OIII]/Hbeta / [NII/Halpha]) for source B: {log_o3n2B} +- {log_o3n2B_err}")
...
print(f"src A metallicity from intersection w/ pettini 2004: {pettini_metal_A}" )
print(f"src B metallicity from intersection w/ pettini 2004: {pettini_metal_B}" )
...
print("R23")
print("="*20)
def R23(oii3726, oii3729, oiii4959, oiii5007, hbeta, oii3726unc, oii3729unc, oiii4959unc, oiii5007unc, hbetaunc):
    num = oii3726+oii3729+oiii4959+oiii5007
    R23 = num/hbeta
    numerr = np.sqrt(oii3726unc**2 + oii3729unc**2 +  oiii4959unc**2 + oiii5007unc**2 )
    R23err = np.sqrt((numerr/num)**2 + (hbetaunc/hbeta)**2) * R23
    return R23, R23err
def kewley_R23(oii3726, oiii4959,oiii5007, hbeta, oii3726unc, oiii4959unc, oiii5007unc, hbetaunc):
...
# double oii R23 
R23_A, R23_A_err = R23(OIIfluxes['fluxes']['A'][0],OIIfluxes['fluxes']['A'][1], OIIIbetas['fluxes']['A'][1],OIIIbetas['fluxes']['A'][2],OIIIbetas['fluxes']['A'][0], 
                       OIIfluxes['flux_uncerts']['A'][0],OIIfluxes['flux_uncerts']['A'][1], OIIIbetas['flux_uncerts']['A'][1],OIIIbetas['flux_uncerts']['A'][2],OIIIbetas['flux_uncerts']['A'][0]
                       )
R23_B, R23_B_err = R23(OIIfluxes['fluxes']['B'][0],OIIfluxes['fluxes']['B'][1], OIIIbetas['fluxes']['B'][1],OIIIbetas['fluxes']['B'][2],OIIIbetas['fluxes']['B'][0], 
                       OIIfluxes['flux_uncerts']['B'][0],OIIfluxes['flux_uncerts']['B'][1], OIIIbetas['flux_uncerts']['B'][1],OIIIbetas['flux_uncerts']['B'][2],OIIIbetas['flux_uncerts']['B'][0]
                       )
...
#kewley R23
kR23_A, kR23_A_err = kewley_R23(OIIfluxes['fluxes']['A'][0], OIIIbetas['fluxes']['A'][1],OIIIbetas['fluxes']['A'][2],OIIIbetas['fluxes']['A'][0], 
                       OIIfluxes['flux_uncerts']['A'][0], OIIIbetas['flux_uncerts']['A'][1],OIIIbetas['flux_uncerts']['A'][2],OIIIbetas['flux_uncerts']['A'][0]
                       )
kR23_B, kR23_B_err = kewley_R23(OIIfluxes['fluxes']['B'][0], OIIIbetas['fluxes']['B'][1],OIIIbetas['fluxes']['B'][2],OIIIbetas['fluxes']['B'][0], 
                       OIIfluxes['flux_uncerts']['B'][0], OIIIbetas['flux_uncerts']['B'][1],OIIIbetas['flux_uncerts']['B'][2],OIIIbetas['flux_uncerts']['B'][0]
                       )
...
print(
    f"log(N2) for source A: {log_NIIalpha_A} +- {log_NIIalpha_A_uncert}"
)
print(
    f"log([OIII/Hbeta]) for source B: {log_OIIIbeta_B} +- {log_OIIIbeta_B_uncert}"
)
print(
    f"log(N2) for source B: {log_NIIalpha_B} +- {log_NIIalpha_B_uncert}"
)
